...
function Hero() {
  ...
  return (
    <>
      <div
        className="relative h-full mt-[-10px] flex items-center justify-center flex-col gap-x-0 sm:flex-row px-5 sm:px-10   w-full 
        bg-gradient-to-br   from-[rgba(45,212,191,0.1)] via-gray-100 to-[rgba(45,212,190,0)] overflow-hidden
        "
      ...
      >
            ...
            <button
              className="rounded-lg font-bold text-sm sm:text-xl backdrop-blur-sm
               bg-teal-400 hover:bg-teal-300 border-2 shadow-lg 
                 border-white-400 text-white py-2 px-6 sm:px-8 mt-5 sm:mt-20 shadow-teal-300/50 
        ...
        <div className="relative robot-wrapper flex justify-end items-end sm:mt-30 w-[200px]   lg:w-[300px] z-10">
          <img
            src="/greenTick.png"
            alt="Tick"
            className="absolute w-8 lg:w-12 top-[18%] left-0 float-slow drop-shadow-[0_5px_10px_rgba(34,197,94,0.5)]"
          />
          <img
            src="/robot.png"
            alt="Robot"
